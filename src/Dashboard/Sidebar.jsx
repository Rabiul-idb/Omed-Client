    ...
    return (
        ...
        <div className="min-w-fit px-3 border-r-2 bg-[#fef5ee] ">
            ...
            <div className="">
                ...
                <NavLink to={'/dashboard/customer-home'} className={`${isAdmin || isSeller ? 'hidden' : ''} btn btn-sm mb-2 flex justify-center items-center text-base `}>Payment History</NavLink>
