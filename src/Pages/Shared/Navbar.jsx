...
const Navbar = () => {
    ...
    return (
        ...
        <div className="">
            ...
            <Link to={'/'} className="ml-2 text-2xl lg:text-3xl font-semibold text-red-600 font-lobster">OMED</Link>
        </div>
        <div>
        ...
        <div className="">
            ...
            <div className="drawer-side z-20">
                ...
                <h2 className="font-bold text-xl flex items-center justify-center gap-2"><img src={logo} className="w-12" alt="" />OMED</h2>
